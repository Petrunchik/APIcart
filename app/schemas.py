...
class CartItem(BaseModel):
    ...
    product: ProductAnswer = Field(..., description="Информация о товаре")
...
class Cart(BaseModel):
    ...
    total_quantity: int = Field(..., ge=0, description="Всего товаров в корзине")
    total_price: Decimal = Field(..., ge=0, description="Общая стоимость")
...
class OrderItem(BaseModel):
    ...
    product: ProductAnswer | None = Field(None, description="Полная информация о товаре")
